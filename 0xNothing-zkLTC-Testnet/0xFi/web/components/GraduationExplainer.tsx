  ...
  return (
    <div className="fi-inline-state fi-graduation-explainer">
      <div>
        ...
        <p>
          Tokens launch on <a href="/0xPump" className="fi-text-link">0xPump</a> with a bonding curve.
          ...
          After that, the token is freely traded on the DEX. Graduated tokens appear in <Link href="/swap" className="fi-text-link">Swap</Link> with a Graduated badge.
        </p>
      </div>
    </div>
  );
