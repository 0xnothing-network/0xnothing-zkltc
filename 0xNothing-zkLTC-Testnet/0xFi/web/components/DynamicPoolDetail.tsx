...
import { TokenPairLogos, tokenImageUrl } from "@/components/TokenLogo";
import { NotDeployed, TransactionStatus } from "@/components/UiStates";
...
import { formatAmount, minimumAfterSlippage, parseAmount, percentageShare, transactionDeadline } from "@/lib/format";
  ...
  return (
    <>
      <header className="fi-trade-header">
        <Link className="fi-icon-button fi-trade-back" href="/" aria-label="Back to markets" title="Back to markets">
